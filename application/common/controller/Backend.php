...
class Backend extends Controller
{
    ...
    // 当前管理员信息
    public $adminNickName = ''; // 管理员昵称
    public $adminUserName = ''; // 管理员用户名
    public $adminInfo = [];
    ...
    public function _initialize()
    {
        ...
        $this->adminNickName = $this->adminInfo['nickname'];
    ...
    protected function token()
    {
        ...
        if (!Validate::is($token, 'token', ['__token__' => $token])) {
            $this->error('Token验证错误!', '', ['__token__' => $this->request->token()]);
        }
     ...
     * 通用JsonResponse
     */
    public function generJson($code=200, $message='', $forwardUrl='reload', $data=[], $callbackType='forward')
    {
        return [
